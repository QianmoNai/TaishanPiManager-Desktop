...
### 🔄 检查更新（本地 v2.64：Gitee，尚未发布 Release）
...
项目保留了从 `v1.0` 起的迭代提交历史，当前版本基线标签已到 `v2.64`。查看历史可进入 [Gitee Tags](https://gitee.com/qianmonai/TaishanPiManager-Desktop/tags) 或 [GitHub Tags](https://github.com/QianmoNai/TaishanPiManager-Desktop/tags)；已编写的版本验证记录保存在 [`docs/`](docs/) 中，并非每个标签都有独立验证文档。
