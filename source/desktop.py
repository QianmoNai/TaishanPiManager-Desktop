...
class Window(QMainWindow):
    def __init__(self, backend=None, autostart=True):
        ...
        side.addWidget(label('●  本机独立应用','sideStatus')); side.addWidget(label('USB / 网络 ADB · v2.43','caption')); body.addWidget(sidebar)
        ...
        self.guarded.extend([self.install_monitor_btn,self.monitor_autostart,self.plugin_center.refresh,self.plugin_primary,self.uninstall_monitor_btn,*self.pin_tool.controls(),*self.radar.controls()])
    ...
    def scroll_page(self):
        ...
        widget=QWidget(); widget.setObjectName('page'); widget.setMinimumWidth(0); widget.setSizePolicy(QSizePolicy.Policy.Ignored,QSizePolicy.Policy.Preferred); layout=QVBoxLayout(widget); layout.setContentsMargins(0,0,5,0); layout.setSpacing(16); area.setWidget(widget); self.stack.addWidget(area)
        return layout
