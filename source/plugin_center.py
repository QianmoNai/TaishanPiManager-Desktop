...
class PluginCenter(QWidget):
    def __init__(self, owner, label, button, card, icon):
        ...
        self.summary=label('3 款可安装插件 · 7 项内置工具','heroCaption'); box.addWidget(self.summary); layout.addWidget(hero)
    ...
    def render_ld06(self,data):
        self.ld06_state=data.get('state','unknown')
